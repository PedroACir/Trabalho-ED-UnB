...
# Chama a função "adiciona" com o nome do arquivo que deseja imprimir e sua prioridade.
gerenciador.adiciona('output.txt', 1)
gerenciador.adiciona('TESTE.txt', 3)
gerenciador.organiza()
# Imprime
gerenciador.imprime()
